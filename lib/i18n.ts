...
export const T = {
  en: {
    ...
    // AI Trade panel
    aiTradeTitle: "Pet Autonomous Trade",
    aiTradeSub: "Your pet picks a four.meme token based on its DNA and trades from its own wallet.",
    aiTradeSuggest: "Let pet pick a token",
    aiTradePicking: "Pet is scanning four.meme...",
    aiTradeBuyBtn: (bnb: number) => `Buy ${bnb} BNB via four.meme`,
    aiTradeSellAll: "Sell full position",
    aiTradeExecuting: "Signing on BSC...",
    aiTradeWaiting: "Waiting for block...",
    aiTradeReason: "Why this pick",
    aiTradePetWallet: "Pet wallet",
    aiTradeBalance: "Balance",
    aiTradeFundPet: "Fund the pet wallet with BNB on BSC to trade.",
    aiTradeSuccess: "Trade confirmed on BSC 🎉",
    aiTradeFail: "Trade failed",
    aiTradeTx: "View on BscScan",
    aiTradeAmount: "Amount",
    aiTradeEstimate: "Estimated",
    aiTradeDisclaimer: "Pet spends only its own wallet. Max 0.005 BNB per trade. Not financial advice.",
  },
  ...
  zh: {
    ...
    aiTradeTitle: "宠物自主交易",
    aiTradeSub: "宠物会根据自己的 DNA 在 four.meme 选一个 token，用自己的钱包下单。",
    aiTradeSuggest: "让宠物挑一个",
    aiTradePicking: "宠物正在扫 four.meme 榜单…",
    aiTradeBuyBtn: (bnb: number) => `用 ${bnb} BNB 在 four.meme 买入`,
    aiTradeSellAll: "清仓卖出",
    aiTradeExecuting: "正在 BSC 上签名…",
    aiTradeWaiting: "等待上链确认…",
    aiTradeReason: "挑选理由",
    aiTradePetWallet: "宠物钱包",
    aiTradeBalance: "余额",
    aiTradeFundPet: "向宠物钱包转一点 BNB 才能开始交易。",
    aiTradeSuccess: "交易已在 BSC 上确认 🎉",
    aiTradeFail: "交易失败",
    aiTradeTx: "在 BscScan 查看",
    aiTradeAmount: "数量",
    aiTradeEstimate: "预计获得",
    aiTradeDisclaimer: "仅由宠物自己的钱包支付，每次最多 0.005 BNB。此非投资建议。",
  },
} as const;
